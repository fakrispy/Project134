...
if stars_data("Distance") < 100:
    less_than_100_df.append(star_names)

gravity_filter_df = []

if stars_data("gravity_list") > 150 or stars_data("gravity list")< 300:
   gravity_filter_df.append(gravity)
